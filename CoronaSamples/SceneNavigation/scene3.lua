...
function scene:create( event )
	...
	print( "Create scene 3's view!" )

	local sceneGroup = self.view

	local helpText = display.newText( "Scene #3", 380, 150, native.systemFont, 55 )
...
function scene:show( event )
	...
	if phase == "will" then
		...
		print("Scene 3 will show.")

		display.setDefault( "background", 0.5, 0.2, 0.8 )
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		print("Scene 3 will hide.")

	elseif phase == "did" then

		-- Called when the scene is now off screen

		print("Scene 3 did hide.")
